...
String generateScopeWidget(ProviderDefinition provider) {
  ...
  final builderType =
      "Widget Function(BuildContext context, ${provider.formBaseProxyWidgetName} ref, $stateType, Widget? child,)?";
  ...
  String inheritedWidget({required String child}) {
    ...
    return '''
    ${provider.formInheritedWidgetName}(
...
return ${inheritedWidget(child: '''
 Consumer(
  builder: (context, ref, child) {
    ...
    if (builder != null) {
      return builder!(context, ${provider.formBaseProxyWidgetName}(ref), state, child);
    }

...
class BaseDialog extends StatelessWidget {
  const BaseDialog({
    ...
    this.contentPadding,
    this.insetPadding =
        const EdgeInsets.symmetric(horizontal: AS.dialogSideInsetPadding, vertical: 24),
    this.content,
    this.actions,
    this.shapeBorder,
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      titlePadding: titlePadding ??
          EdgeInsets.all(24).copyWith(
            bottom: 0,
            top: 12,
            right: showCloseButton ? 12 : 24,
          ),

...
class AsyncListPickerDialog<T, I> extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final multiSelectButton = AppFilledButton(
      label: Text('Select (${selectedState.value.length})'),
      onPressed: () async {
  ...
  Widget build(BuildContext context) {
    return AppListTile(
      ...
      trailing: multiSelect
          ? AppIcon(
              isSelected ? AS.checkBoxIcon : AS.checkBoxOutlineBlankIcon,
              color: context.primaryColor,
            )
          : isSelected
              ? AppIcon(AS.checkIcon)
              : null,
      onTap: onTap,

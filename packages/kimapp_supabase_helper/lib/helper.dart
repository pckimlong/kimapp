...
extension SupabaseX on Ref {
  ...
  SupabaseQueryBuilder supabaseTable(String tableName) => supabaseClient.from(tableName);
  SupabaseStorageClient get supabaseStorage => supabaseClient.storage;
  StorageFileApi supabaseStorageBucket(String bucketName) => supabaseStorage.from(bucketName);
}

...
@freezed
sealed class DemoDetailModel with _$DemoDetailModel implements BaseDemoSchema, IDemoModel {
  ...
  factory DemoDetailModel.fromJson(Map<String, dynamic> json) => _$DemoDetailModelFromJson(json);
...
sealed class DemoLiteModel with _$DemoLiteModel implements BaseDemoSchema {
  ...
  factory DemoLiteModel.fromJson(Map<String, dynamic> json) => _$DemoLiteModelFromJson(json);

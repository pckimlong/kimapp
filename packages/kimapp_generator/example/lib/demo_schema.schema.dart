...
abstract class BaseDemoModel {}

/// Base model class for DemoModel.
@freezed
class DemoModel with _$DemoModel implements BaseDemoModel {
  const DemoModel._();
...
@freezed
class DemoDetailModel with _$DemoDetailModel implements BaseDemoModel {
...
@freezed
class DemoLiteModel with _$DemoLiteModel implements BaseDemoModel {

...
import 'package:flutter_riverpod/src/consumer.dart';
    ...
    bool _debugCheckHasClassGenerate2StateWidget(BuildContext context) {
      assert(() {
        if (context.widget is! ClassGenerate2StateWidget &&
            context.findAncestorWidgetOfExactType<ClassGenerate2StateWidget>() == null) {
    ...
    class _ClassGenerate2ParamsProvider extends InheritedWidget {
      ...
      static _ClassGenerate2ParamsProvider? of(BuildContext context) {
        return context.dependOnInheritedWidgetOfExactType<_ClassGenerate2ParamsProvider>();
      }
          ...
          return Consumer(
            builder: (context, ref, child) {
              ...
              final state = ref.watch(
                classGenerate2Provider(a).select((state) => state.whenData((data) => data.id)),
              );
              return builder(context, ref, state);
            },
          );
        ...
        Widget build(BuildContext context) {
          ...
          return Consumer(
            builder: (context, ref, child) {
              ...
              final state = ref.watch(
                classGenerate2Provider(a).select((state) => state.whenData((data) => data.name)),
              );
              return builder(context, ref, state);
            },
          );
...
import 'package:flutter_riverpod/src/consumer.dart';
    ...
    bool _debugCheckHasClassGenerate3StateWidget(BuildContext context) {
      assert(() {
        if (context.widget is! ClassGenerate3StateWidget &&
            context.findAncestorWidgetOfExactType<ClassGenerate3StateWidget>() == null) {
          throw FlutterError.fromParts(<DiagnosticsNode>[
    ...
    class _ClassGenerate3ParamsProvider extends InheritedWidget {
      ...
      static _ClassGenerate3ParamsProvider? of(BuildContext context) {
        return context.dependOnInheritedWidgetOfExactType<_ClassGenerate3ParamsProvider>();
      }
    ...
    return _ClassGenerate3ParamsProvider(
      ...
      class ClassGenerate3StateWidgetIdWidget extends StatelessWidget {
        ...
        final String b = param.b;
              ...
              final state = ref.watch(
                classGenerate3Provider(a, b: b).select((state) => state.whenData((data) => data.id)),
              );
              return builder(context, ref, state);
            },
          );
      ...
      class ClassGenerate3StateWidgetNameWidget extends StatelessWidget {
        ...
        final String b = param.b;
              ...
              final state = ref.watch(
                classGenerate3Provider(a, b: b).select((state) => state.whenData((data) => data.name)),
              );
              return builder(context, ref, state);
            },
          );
...
import 'package:flutter_riverpod/src/consumer.dart';
    ...
    bool _debugCheckHasAsyncGenerateStateWidget(BuildContext context) {
      assert(() {
        if (context.widget is! AsyncGenerateStateWidget &&
            context.findAncestorWidgetOfExactType<AsyncGenerateStateWidget>() == null) {
          throw FlutterError.fromParts(<DiagnosticsNode>[
    ...
    class _AsyncGenerateParamsProvider extends InheritedWidget {
      ...
      static _AsyncGenerateParamsProvider? of(BuildContext context) {
        return context.dependOnInheritedWidgetOfExactType<_AsyncGenerateParamsProvider>();
      }
        ...
        Widget build(BuildContext context) {
          ...
          return Consumer(
            builder: (context, ref, child) {
              ...
              final state = ref.watch(
                asyncGenerateProvider(hello).select((state) => state.whenData((data) => data.id)),
              );
              return builder(context, ref, state);
            },
          );
        ...
        Widget build(BuildContext context) {
          ...
          return Consumer(
            builder: (context, ref, child) {
              ...
              final state = ref.watch(
                asyncGenerateProvider(hello).select((state) => state.whenData((data) => data.name)),
              );
              return builder(context, ref, state);
            },
          );

...
class ExampleModel with _$ExampleModel {
  ...
  @TableModel('xxx')
  const factory ExampleModel({required int id, required String name}) = _ExampleModel;
...
Future<IList<ExampleModel>> asyncIListGenerate(AsyncIListGenerateRef ref) async {
  return [const ExampleModel(id: 1, name: 'test')].lock;
}
...
class ClassGenerate extends _$ClassGenerate {
  ...
  FutureOr<List<ExampleModel>> build(int param) async {
    return [const ExampleModel(id: 1, name: 'test f')];
  }
}

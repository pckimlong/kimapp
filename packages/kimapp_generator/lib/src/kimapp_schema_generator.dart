...
String _baseSchemaModelClassName(_SchemaMetaData schemaMetaData) {
  return 'Base${schemaMetaData.className}Model';
}
...
String _generateSchemaBaseClass(_SchemaMetaData schemaMetaData) {
  return '''
    ...
    abstract class ${_baseSchemaModelClassName(schemaMetaData)} {}
''';
}
...
String _generateBaseModelClass(_SchemaMetaData schema, List<_FieldDefinition> allFields) {
  ...
  final baseClass = _baseSchemaModelClassName(schema);

  buffer.writeln('/// Base model class for $baseModelName.');
  buffer.writeln('@freezed');
  buffer.writeln('class $baseModelName with _\$$baseModelName implements $baseClass {');
...
String _generateModelClass(_ModelDefinition model, _SchemaMetaData schema) {
  ...
  buffer.writeln('@freezed');
  buffer.writeln('class ${model.modelName} with _\$${model.modelName} implements $baseClass {');
